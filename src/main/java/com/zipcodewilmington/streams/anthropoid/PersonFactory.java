...
public final class PersonFactory {
    ...
    public List<Person> createPersonList(int listSize) {
        Supplier<Person> p = this::createRandomPerson;
        return  Stream.generate(p).limit(listSize).collect(Collectors.toList());
    }
    ...
    public Person[] createPersonArray(int arrayLength) {
        ...
        Supplier<Person> p = this::createRandomPerson;
        List<Person> list =  Stream.generate(p).limit(arrayLength).collect(Collectors.toList());
        return list.toArray(new Person[arrayLength]);
    }
    ...
    public Stream<Person> createPersonStream(int streamCount) {
        Supplier<Person> p = this::createRandomPerson;
        return Stream.generate(p).limit(streamCount);
    }
}
